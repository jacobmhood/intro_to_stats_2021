...
3. After your data is ready, save it to your local replication project folder and create a `.Rproj` file in this folder before you start coding. Make sure to sync your coding files once in a while to track your coding history. Note that you cannot sync your raw data since it is too large, but you should sync the rest of your files. 
