...
ggsave("fig1.png") #saving figure as png to import into overleaf
```
...
```{r}
# Creating model table for women
...
```{r}
# Using seg function to calculate index of dissimilarity, for men, each decade 
seg(men1980dissim)
