...
```{r}
dissim1980 <- data_clean %>% filter(YEAR = 1980)
length(dissim1980$occ_2digit) 
```

```{r}
dissim2000 <- data_clean %>% filter(YEAR == 2000)
(dissim2000$occ_2digit)
```

```{r}
dissim1 <- data_clean %>% filter(YEAR == 1980) %>% filter(RACEGENDER == "white male")
w <- table(dissim1$occ_2digit)
w <- as.data.frame(w)
w
```

```{r}
dissim2 <- data_clean %>% filter(YEAR == 1980) %>% filter(RACEGENDER == "black male")
t <- table(dissim1$occ_2digit)
t <- as.data.frame(t)
t
```

```{r}
dissim3 <- data_clean %>% filter(YEAR == 1990) %>% filter(RACEGENDER == "white male")
t <- table(dissim1$occ_2digit)
t <- as.data.frame(t)
t
```
...
```{r}
dissim4 <- data_clean %>% filter(YEAR == 1990) %>% filter(RACEGENDER == "black male")
t <- table(dissim1$occ_2digit)
t <- as.data.frame(t)
t
```
...
```{r}
dissim5 <- data_clean %>% filter(YEAR == 2000) %>% filter(RACEGENDER == "white male")
t <- table(dissim1$occ_2digit)
t <- as.data.frame(t)
t
```
...
```{r}
dissim6 <- data_clean %>% filter(YEAR == 2000) %>% filter(RACEGENDER == "black male")
t <- table(dissim1$occ_2digit)
t <- as.data.frame(t)
t
```
...
```{r}
dissim7 <- data_clean %>% filter(YEAR == 2010) %>% filter(RACEGENDER == "white male")
t <- table(dissim1$occ_2digit)
t <- as.data.frame(t)
t
```
...
```{r}
dissim8 <- data_clean %>% filter(YEAR == 2010)%>% filter(RACEGENDER == "black male")
t <- table(dissim1$occ_2digit)
t <- as.data.frame(t)
t
```
