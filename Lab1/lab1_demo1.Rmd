...
1. For "displayed equations" (equations that will break your lines), use the double dollar sign `$$` to wrap your expression: $$\overline{y} = \displaystyle \frac{y_1 + y_2 + y_3 + ... + y_n}{n} = \displaystyle \frac{\sum_{i = 1}^{n} y_i}{n}$$ 
...
3. For detailed documentation, see [here](https://yihui.org/knitr/options/).
