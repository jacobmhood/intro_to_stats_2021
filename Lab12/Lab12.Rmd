...
To check if the sample is balanced or not, we first examine the difference in means by treatment status for outcome variable and covariants. As we can see, the difference in mean for match score and for covariates are statistically significant.  
